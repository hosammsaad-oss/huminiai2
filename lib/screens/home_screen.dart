...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  subtitle: const Text('وكيل الحسابات الآلي'),
  onTap: () {
    Navigator.pop(context); // إغلاق القائمة الجانبية
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SmartAccountsAnalysisPage(
          userId: FirebaseAuth.instance.currentUser?.uid ?? '',
                  ...
                  ListTile(
  leading: const Icon(Icons.dashboard_customize, color: Color(0xFF6B4EFF)),
  title: Text(
    'لوحة التحكم الذكية',
  ...
  onTap: () {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const SmartDashboardScreen()), // تأكد من اسم الكلاس هنا
    );
  },
),
                  const Divider(),
